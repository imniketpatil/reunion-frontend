...
function AddTask({ handleSave, toggleModal, handleCancel, setIsModalOpen }) {
  ...
  const { mutate, isLoading, isError, error } = useAddTaskMutation();

  const accessToken = localStorage.getItem("accessToken");

  const onSubmit = (data) => {
    // console.log(data);
    mutate({ ...data, priority, status, accessToken, setIsModalOpen });
  };
